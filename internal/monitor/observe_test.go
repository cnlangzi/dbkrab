...
func TestLogsDB_WritePullLog(t *testing.T) {
	...
	if logs[0].PullID != "test-pull-001" {
		t.Errorf("Expected PullID test-pull-001, got %s", logs[0].PullID)
	}
